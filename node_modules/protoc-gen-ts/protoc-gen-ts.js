...
var require$$5 = require('buffer');
var require$$7 = require('inspector');
...
var typescript = {
  get exports(){ return typescriptExports; },
  set exports(v){ typescriptExports = v; },
};
...
(function (module) {
	...
	(function (ts) {
	    ...
	    function tryGetNodePerformanceHooks() {
	        if (typeof process !== "undefined" && process.nextTick && !process.browser && 'object' === "object" && typeof commonjsRequire === "function") {
	            try {
	                var performance_1;
	...
	(function (ts) {
	    ...
	    try {
	        ...
	        etwModule = commonjsRequire(etwModulePath);
	    }
	    catch (e) {
	        etwModule = undefined;
	    }
	    ...
	    (function (tracingEnabled) {
	        ...
	        function startTracing(tracingMode, traceDir, configFilePath) {
	            ...
	            fs.writeSync(traceFd, "[\n"
	                + [__assign({ name: "process_name", args: { name: "tsc" } }, meta), __assign({ name: "thread_name", args: { na